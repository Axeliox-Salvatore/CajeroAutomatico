...
{
    public partial class Generarremesa: Form
    {
        public Generarremesa()
        {
            InitializeComponent();
        }
        ...
        private void btngenerarremesa_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conexion = ConexionDB.Conexion())
            {
                ...
                if (montoRemesa > saldoActual)
                {
                    MessageBox.Show("Saldo insuficiente para generar la remesa.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }

                // Restar la remesa al saldo
                ...
                MessageBox.Show("Remesa generada y saldo actualizado.", "Éxito", MessageBoxButtons.OK, MessageBoxIcon.Information);
                conexion.Close();
            }
        }
    }
